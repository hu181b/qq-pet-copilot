...
本仓库为 hu181b 维护的真机优化版，原仓库为 https://github.com/490720818/qq-pet-copilot 。保留 GPL-3.0 许可证与上游历史。当前发行 v1.4，修改概览和使用说明见 RELEASE-v1.4.md。
...
- 运行 tools/fetch_ocr_models.py、tools/fetch_scrcpy.py，按需 tools/fetch_minitouch.py --arch arm64-v8a；然后 tools/write_version.py --tag v1.4 --repo hu181b/qq-pet-copilot，python -m PyInstaller --noconfirm QQPetCopilot.spec。
